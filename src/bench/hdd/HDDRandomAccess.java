    ...
    class RandomAccess {
        ...
        public long randomReadFixedSize(String filePath, int bufferSize,
            ...
            while (counter++ < toRead) {
                ...
                long randomPosition = (long) (random.nextDouble() * (fileSize - bufferSize));
        ...
        /**
         * Write data to random positions from a fixed size buffer to a
         * given file using RandomAccessFile
         *
         * @param filePath
         *            Full path to file on disk
         ...
         * @param toWrite
         *            Number of steps to repeat random write
         * @return Amount of time needed to finish given writes in milliseconds
         * @throws IOException
         */
        public long randomWriteFixedSize(String filePath, int bufferSize,
            ...
            int counter = 0;
            // buffer for writing with random data
            byte[] bytes = new byte[bufferSize];
            // timer
            Timer timer = new Timer();
        ...
        /**
         * Write data to random positions from a fixed size buffer to a
         * given file using RandomAccessFile for a given amount of time
         *
         * @param filePath
         *            Full path to file on disk
         * @param bufferSize
         *            Size of byte buffer to write at each step
         * @param millis
         *            Total time to write to file
         * @return Number of writes in the given amount of time
         * @throws IOException
         */
